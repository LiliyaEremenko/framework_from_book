<?php
	...
	require_once $_SERVER['DOCUMENT_ROOT'] . '/framework/project/config/connection.php';
	...
	spl_autoload_register(function($class) {
		...
		$path = $_SERVER['DOCUMENT_ROOT'] . '/framework/' . $nameSpace . '/' . $className . '.php';
	...
	$routes = require $_SERVER['DOCUMENT_ROOT'] . '/framework/project/config/routes.php';
